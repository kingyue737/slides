...
<template>
  <span
    ...
    bg-gradient-to-r from-teal-300 via-blue-400 to-blue-800
    op75 dark:op50
  ...
  <Transition name="fade">
    <Nustar v-if="$slidev.nav.currentLayout !== 'cover'" fill="#565656" fill-opacity="0.5" class="absolute right-2 bottom-2 h-22" />
  </Transition>
</template>
